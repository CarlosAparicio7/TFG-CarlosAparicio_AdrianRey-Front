                ...
                <Paper elevation={0} sx={{ p: { xs: 2, md: 5 }, backgroundColor: 'rgba(255, 255, 255, 0.12)', borderRadius: { xs: 0, md: 6 }, width: '100%', minHeight: '85vh', boxSizing: 'border-box', border: '1px solid rgba(255, 255, 255, 0.2)', display: 'flex', flexDirection: 'column', backdropFilter: 'blur(20px)', boxShadow: '0 8px 32px 0 rgba(0, 0, 0, 0.37)' }}>
                    ...
                    <Grid container spacing={4} sx={{ width: '100%', margin: 0, px: { xs: 0, md: 2 } }}>
                        <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }} sx={{ display: 'flex', justifyContent: 'center' }}>
                            <Card sx={{ width: '100%', maxWidth: '450px', display: 'flex', flexDirection: 'column', borderRadius: 5, background: 'linear-gradient(135deg, #007bb3 0%, #f18a3a 100%)', border: '1px solid rgba(255, 255, 255, 0.4)', boxShadow: '0 15px 35px rgba(0,0,0,0.3)', transition: 'all 0.4s ease', '&:hover': { transform: 'translateY(-12px)', boxShadow: '0 25px 50px rgba(0,0,0,0.4)', border: '1px solid #fff' } }}>
                                
                                <Box sx={{ m: 2, borderRadius: 4, overflow: 'hidden', position: 'relative', boxShadow: '0 10px 20px rgba(0,0,0,0.2)', bgcolor: '#003a54' }}>
                                    <CardMedia component="img" src="https://via.placeholder.com/600x400?text=Poster+Pelicula" alt="Poster" sx={{ height: 420, width: '100%', objectFit: 'cover', transition: 'transform 0.6s ease', '&:hover': { transform: 'scale(1.08)' } }} />
                                </Box>
                                ...
                                <CardContent sx={{ flexGrow: 1, p: 3, pt: 1 }}>
                                    ...
                                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                                        ...
                                        <Box sx={{ ml: 1.5, bgcolor: '#f06b06', px: 1.5, py: 0.3, borderRadius: 2 }}>
                                            <Typography variant="caption" sx={{ fontWeight: 900, color: '#fff', fontSize: '0.9rem' }}>4.5</Typography>
                                        </Box>
                                    </Box>

                                    <Typography variant="body2" sx={{ color: '#f1f5f9', lineHeight: 1.7, display: '-webkit-box', overflow: 'hidden', WebkitBoxOrient: 'vertical', WebkitLineClamp: 2, fontSize: '1.05rem', fontWeight: 500 }}>
                                ...
                                <Box sx={{ p: 3, pt: 0 }}>
                                    <Button variant="contained" fullWidth sx={{ bgcolor: '#005f8a', borderRadius: 3, textTransform: 'none', fontWeight: 900, py: 1.8, fontSize: '1.1rem', '&:hover': { bgcolor: '#004a6d' } }}>
                                        Ver Película
                                    </Button>
                                </Box>
                            </Card>
