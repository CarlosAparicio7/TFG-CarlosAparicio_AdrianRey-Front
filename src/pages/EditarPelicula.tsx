                            ...
                            <Grid container spacing={3}>
                                <Grid size={{ xs: 12, md: 6 }}>
                                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
                                        <TextField required fullWidth label="Nombre de la Película" variant="outlined" value={datosPelicula.nombre} onChange={editarNombre} sx={{ bgcolor: '#fff', borderRadius: 3, '& .MuiOutlinedInput-root': { borderRadius: 3, fontWeight: 600 } }} />
                                        <TextField required fullWidth label="Director" variant="outlined" value={datosPelicula.director} onChange={editarDirector} sx={{ bgcolor: '#fff', borderRadius: 3, '& .MuiOutlinedInput-root': { borderRadius: 3, fontWeight: 600 } }} />
                                        <TextField required fullWidth label="Géneros" variant="outlined" value={datosPelicula.genero} onChange={editarGenero} sx={{ bgcolor: '#fff', borderRadius: 3, '& .MuiOutlinedInput-root': { borderRadius: 3, fontWeight: 600 } }} />
                                        <TextField required fullWidth label="Descripción" variant="outlined" value={datosPelicula.descripcion} multiline rows={5} onChange={editarDescripcion} sx={{ bgcolor: '#fff', borderRadius: 3, '& .MuiOutlinedInput-root': { borderRadius: 3, fontWeight: 600 } }} />
                                        <TextField required fullWidth label="Valoración" variant="outlined" value={datosPelicula.valoracion} type="number" onChange={editarValoracion} slotProps={{ htmlInput: { min: 1, max: 10, step: 0.1 } }} sx={{ bgcolor: '#fff', borderRadius: 3, '& .MuiOutlinedInput-root': { borderRadius: 3, fontWeight: 600 } }} />
                                    </Box>
                                </Grid>
                                ...
                                <Grid size={{ xs: 12, md: 6 }}>
                                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5, height: '100%' }}>
                                        ...
                                        <TextField fullWidth label="O pega el Enlace URL de Portada" variant="outlined" placeholder="https://..." value={datosPelicula.portada.startsWith('blob:') ? "" : datosPelicula.portada} onChange={editarPortada} sx={{ bgcolor: '#fff', borderRadius: 3, '& .MuiOutlinedInput-root': { borderRadius: 3, fontWeight: 600 } }} />
                                        ...
                                        <TextField fullWidth label="Enlace URL de Video" variant="outlined" placeholder="https://..." value={archivoBinario ? "" : datosPelicula.urlVideo} onChange={editarUrlVideoTexto} disabled={!!archivoBinario} sx={{ bgcolor: '#fff', borderRadius: 3, '& .MuiOutlinedInput-root': { borderRadius: 3, fontWeight: 600 } }} />
                                    </Box>
                                </Grid>
                            </Grid>
